...
namespace StellarMass.InputManagement.MapInstances
{
    ...
    public class PauseMenu : MapInstance, InputActionsGenerated.IPauseMenuActions
    {
        ...
        public PauseMenu(InputActionsGenerated.PauseMenuActions actions)
        {
        ...
        void InputActionsGenerated.IPauseMenuActions.OnNavigate(InputAction.CallbackContext context) => OnNavigate?.Invoke(context.phase, context.ReadValue<Vector2>());
        void InputActionsGenerated.IPauseMenuActions.OnSubmit(InputAction.CallbackContext context) => OnSubmit?.Invoke(context.phase);
        void InputActionsGenerated.IPauseMenuActions.OnUnpause(InputAction.CallbackContext context) => OnUnpause?.Invoke(context.phase);
    }
}
